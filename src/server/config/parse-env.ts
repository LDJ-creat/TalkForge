...
function parseSecrets(env: NodeJS.ProcessEnv): RuntimeSecrets {
  return {
    ...
    ttsBaseUrl: readEnv(env, "TTS_BASE_URL"),
    ttsModel: readEnv(env, "TTS_MODEL"),
    ttsVoice: readEnv(env, "TTS_VOICE"),
    pronunciationApiKey: readEnv(env, "PRONUNCIATION_API_KEY"),
    pronunciationApiSecret: readEnv(env, "PRONUNCIATION_API_SECRET"),
    pronunciationAppId: readEnv(env, "PRONUNCIATION_APP_ID"),
    pronunciationWsBaseUrl: readEnv(env, "PRONUNCIATION_WS_BASE_URL"),
